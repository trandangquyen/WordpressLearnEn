...
<?php else : ?>
    ...
    <footer id="colophon" class="footer footer_type_default<?php echo esc_attr($footer_class); ?>">
        <div class="container">
            ...
            <?php $footer_copyright_default = sprintf(__('Copyright &copy; Secondary School Theme by <a href="%s" target="_blank">Stylemix Themes</a>', 'smarty'), 'http://localhost:8080/WordPressLearnEn'); ?>
            <?php
            /* --- Copyright --- */
...
<script lang="javascript">
    (function () {
        ...
        ga.async = 1;
        ga.src = '//live.vnpgroup.net/js/web_client_box.php?hash=ab08b92c287a60e5415cb098bdd41f39&data=eyJzc29faWQiOjQ4NjYzNzMsImhhc2giOiI2ZDAzMDgzYTk5ZDI2YjBjYjEzNzExMmJkZGUzNWIzMCJ9&pname=' + pname;
