jQuery(document).ready(function ($) {
    ...
    var $headerViewStyle = $('#customize-control-header_view_style input[type="radio"]:checked').val(),
        ...
        $contactDetailsSchedule = $("#customize-control-contact_details-schedule"),
        ...
        $topBarShoppingCart = $("#customize-control-top_bar_shopping_cart");
    ...
    $(document).on("change", "#top_bar_contacts", function() {
        if( ! $("#top_bar_contacts").prop("checked") ) {
            ...
            if( $('#customize-control-header_view_style input[type="radio"]:checked').val() == 1) {
                $contactDetailsSchedule.show();
            }
