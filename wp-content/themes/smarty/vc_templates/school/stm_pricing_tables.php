							...
							<div class="stm-pricing-table <?php echo ( ( esc_attr( ${'pt_' . $i . '_featured'} ) ) ? 'stm-pricing-table_featured' : '' ); ?>" <?php echo esc_attr( ${'pt_' . $i . '_table_style'} ); ?>>
								...
								<?php if( isset( ${'pt_' . $i . '_link'}['url'] ) && !empty( ${'pt_' . $i . '_link_text'} ) ) : ?>
									<div class="stm-pricing-table__action">
										<a href="<?php echo esc_url( ${'pt_' . $i . '_link'}['url'] ); ?>" target="<?php echo esc_attr( ${'pt_' . $i . '_link'}['target'] ); ?>" class="stm-btn stm-btn_outline stm-btn_blue stm-btn_sm stm-btn_icon-right"><?php echo esc_html( ${'pt_' . $i . '_link_text'} ); ?><i class="stm-icon stm-icon-arrow-right"></i></a>
									</div>
								<?php endif; ?>
							</div>
						</div>
