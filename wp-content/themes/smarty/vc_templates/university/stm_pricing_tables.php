				...
				<?php for( $i = 1; $i <= 3; $i++ ) : ?>
					<?php if( !empty( ${'pt_' . $i . '_periods'} ) ) : ?>
						<div class="stm-pricing__tables-col">
							<div class="stm-pricing-table <?php echo ( ( esc_attr( ${'pt_' . $i . '_featured'} ) ) ? 'stm-pricing-table_featured' : '' ); ?>" <?php echo esc_attr( ${'pt_' . $i . '_table_style'} ); ?>>
								...
								<?php if( isset( ${'pt_' . $i . '_link'}['url'] ) && !empty( ${'pt_' . $i . '_link_text'} ) ) : ?>
									<div class="stm-pricing-table__action">
										<a href="<?php echo esc_url( ${'pt_' . $i . '_link'}['url'] ); ?>" target="<?php echo esc_attr( ${'pt_' . $i . '_link'}['target'] ); ?>" class="stm-btn stm-btn_outline stm-btn_red stm-btn_sm stm-btn_icon-right"><?php echo esc_html( ${'pt_' . $i . '_link_text'} ); ?><i class="fa fa-chevron-right" aria-hidden="true"></i></a>
									</div>
								<?php endif; ?>
							</div>
						</div>
